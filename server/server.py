...
GATE_SYSTEM = (
    ...
    "curiosity gap or hype instead of informing — \"you won't believe what happens next\", "
    "\"this one weird trick\", \"we know if you own a pair of white vans\", \"N things that "
    "will blow your mind\", withholding the payoff to force the click. A straight, "
    "informative headline that tells you the news (\"Fed raises interest rates 0.25%\") is "
    "'no'. Also "
